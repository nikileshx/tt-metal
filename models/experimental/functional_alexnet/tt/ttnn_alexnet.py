...
def Conv(
    ...
    [x, [out_height, out_width], [out_weight, out_bias]] = ttnn.conv2d(
        input_tensor=x,
...
def ttnn_alexnet(device, x, parameters):
    ...
    shard_spec = ttnn.ShardSpec(shard_grid, (32, 192), ttnn.ShardOrientation.ROW_MAJOR)
    sharded_mem_config = ttnn.MemoryConfig(ttnn.TensorMemoryLayout.HEIGHT_SHARDED, ttnn.BufferType.L1, shard_spec)
    ...
    shard_spec = ttnn.ShardSpec(shard_grid, (192, 32), ttnn.ShardOrientation.ROW_MAJOR)
