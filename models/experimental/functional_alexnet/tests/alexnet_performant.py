...
def run_alexnet_trace_inference(
    device,
    device_batch_size,
    act_dtype,
    weight_dtype,
...
def run_alexnet_trace_2cqs_inference(
    device,
    device_batch_size,
    act_dtype,
    weight_dtype,
...
@pytest.mark.parametrize("enable_async_mode", (False, True), indirect=True)
def test_run_alexnet_trace_2cqs_inference(
    device,
    device_batch_size,
    act_dtype,
    weight_dtype,
    ...
    run_alexnet_trace_2cqs_inference(
        device=device,
...
def test_run_alexnet_inference(
    device,
    device_batch_size,
    act_dtype,
    weight_dtype,
):
    run_alexnet_inference(
        device,
        device_batch_size,
        act_dtype,
        weight_dtype,
