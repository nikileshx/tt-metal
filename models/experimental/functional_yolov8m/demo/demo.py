...
from models.experimental.functional_yolov8m.demo.demo_utils import LoadImages, preprocess, postprocess
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("models/experimental/functional_yolov8m/demo/images/kitchen.jpg", "torch_model"),
        ("models/experimental/functional_yolov8m/demo/images/kitchen.jpg", "tt_model"),
        ...
        ("models/experimental/functional_yolov8m/demo/images/person.jpg", "torch_model"),
        ("models/experimental/functional_yolov8m/demo/images/person.jpg", "tt_model"),
...
def test_demo(device, source, model_type, res):
    ...
    if model_type == "torch_model":
        model = attempt_load("yolov8m.pt", map_location="cpu")
