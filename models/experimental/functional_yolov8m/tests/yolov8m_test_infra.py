...
def load_ttnn_model(device, torch_model, res=(640, 640)):
    ...
    ttnn_model = partial(YOLOv8m, device=device, parameters=parameters)
    return ttnn_model
...
class Yolov8TestInfra:
    ...
    def validate(self, output_tensor=None):
        ...
        logger.info(
            f"Yolov8m batch_size={self.batch_size}, act_dtype={self.act_dtype}, weight_dtype={self.weight_dtype}, PCC={self.pcc_message}"
        )
